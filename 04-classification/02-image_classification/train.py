...
# In order to make the most of our few training examples, we will "augment" them via
# a number of random transformations, so that our model would never see twice the
# exact same picture. This helps prevent overfitting and helps the model generalize
# better.
# see:
...
validation_iterator = validation_data_generator.flow_from_directory("data/test", class_mode = "categorical", color_mode = "grayscale", target_size = (256, 256))
...
#        epochs=5,
#        validation_data=validation_iteration,
